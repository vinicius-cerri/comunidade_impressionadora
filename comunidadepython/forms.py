...
class FormCriarConta(FlaskForm):
    ...
    # O Nome da Função obrigatoriamente deve começar com o "validate_"
...
class FormEditarPerfil(FlaskForm):
    ...
    # Verificar se o usuário trocou de e-mail para um que não existe (diferente dos outros usuários)
    def validate_email(self, email):
